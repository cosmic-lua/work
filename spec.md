...
## Decomposition filed, 2026-08-19 (complete-latest-ABI direction from the owner)

The owner's direction: complete support for the latest Landlock ABI,
fully defined and specified on the board. The decomposition sketch above
is superseded by filed items — phase 1: 3I7LAXcj (R4 race-free
optional), 3I7LBrUN (R1 report/strict/handled-drop + R8 record); phase
2: 3I7LDODd (ABI-4 bindings, whilp/cosmopolitan#266 wave 1), 3I7LEsGv
(ABI 5–9 bindings, wave 2), 3I7LGcLa (wave-1 pin bump), 3I7LNDrF
(wave-2 pin bump, in triage pending a slot); phase 3: 3I7LMwgC (net
section R7, in triage pending a slot), 3I7LNOT7 (quicksand Box net
tier, in triage pending a slot), 3I7LKuM2 (facade to ABI 9 — the one
item with open vocabulary questions, in plan). Blocked_by edges carry
the landing order; the two cosmopolitan items' PRs land in that repo
(cross-repo field per 3I3z2gOF when it lands).
