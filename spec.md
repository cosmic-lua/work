...
cosmic-lua/work, read and write on a branch. Read-only access to
cosmic-lua/cosmic, to confirm its current `bin/cosmic.pin` values
(url + sha256) if they've moved past the ones quoted above.
