...
bulk. The in-place formatter already accepts several paths in one call (verified),
so this is about the stage knowing its own failing set, not about the fixer.
