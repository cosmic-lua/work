...
Ready when: `ls docs/guides/htmx.md` prints the path (the guide child
has merged; an eval task before the guide exists measures the gap the
guide is meant to close, which is a different experiment).
