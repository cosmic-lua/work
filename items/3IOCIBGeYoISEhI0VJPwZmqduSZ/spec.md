...
shape is charted in `docs/design/test-runner.md` on branch
`claude/cosmic-test-runner-rgb819` (design-only PR
whilp/cosmic#1366, closed in favor of this item): discovery by name
